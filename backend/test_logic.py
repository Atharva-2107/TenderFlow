...
#     # 🛠️ THE FIX: Convert LlamaIndex Documents to LangChain Documents
...
#     print(f"✅ SUCCESS. Found {len(compressed_docs)} highly relevant chunks.")
...
#         print(f"\n🏆 RANK {i+1} (Score: {formatted_score})")
